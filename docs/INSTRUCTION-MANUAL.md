...
- [Choose layouts and button options](#choose-layouts-and-button-options)
...
The [button option guide](../modules.md) is the sole table of all 53 values in
code order. In an installed or portable package, open `modules.md` beside
`LCDSirPlus.exe`.
