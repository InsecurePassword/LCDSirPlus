...
This is the canonical quick reference for all 53 button options, in source
order. Its table is mirrored exactly in the instruction manual and PDF. For
setup and editing steps, see the
